 ...
 *
 *   // network
 *   CFigureNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.figure.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFigureNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FigureNetwork
// //   -- signature requirements : Key1(User)
// class CFigureNetworkVariable : public CGovernanceObject
// {
// private:
