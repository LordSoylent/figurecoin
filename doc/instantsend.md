...
This mechanism has been integrated into Bitcore-Node-Figure which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/figurecoin/insight-api-figure#web-socket-api](https://github.com/figurecoin/insight-api-figure#web-socket-api) 
* API: [https://github.com/figurecoin/insight-api-figure#instantsend-transactions](https://github.com/figurecoin/insight-api-figure#instantsend-transactions) 
...
By default, the Figure Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Figure Core daemon:
