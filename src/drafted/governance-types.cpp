...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FigureNetwork") type = FigureNetwork;
    if(strType == "FigureNetworkVariable") type = FigureNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FigureNetwork) s = "FigureNetwork";
    if(type == FigureNetworkVariable) s = "FigureNetworkVariable";
