    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Figure Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Figure Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  figure-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Figure in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FIG, 0.1 FIG, 1 FIG and 10 FIG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://figurecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://figurecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Figure Core is shutting down...") + "<br /><br />" +
