    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FIG-light"), QVariant("light"));
    ui->theme->addItem(QString("FIG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FIG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FIG-traditional"), QVariant("trad"));
