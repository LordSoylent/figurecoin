...
Only requiring some minor changes is figure.cpp.
...
Changes to figure.cpp
----------------------
figure.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
