    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Figure Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Figure address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and figure: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Figure Core"), this);
    aboutAction->setStatusTip(tr("Show information about Figure Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Figure Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Figure addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Figure addresses"));
    ...
    openAction->setStatusTip(tr("Open a figure: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Figure Core help message to get a list with possible Figure Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Figure Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Figure network", "", count));
}
...
{
    QString strTitle = tr("Figure Core"); // default title
