...
{
    if(fLiteMode) return; // ignore all Figure related functionality
...
/*
    ...
    allow endless transaction that would bloat Figure and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("figure-privatesend");
